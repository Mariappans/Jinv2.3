...
WebUI.setText(findTestObject('Object Repository/JIN 2.3/Page_Employees/input_close_first_name'), 'Employer' + new Random().nextInt(
        1000))

WebUI.click(findTestObject('Object Repository/JIN 2.3/Page_Employees/label_Last Name'))

WebUI.setText(findTestObject('Object Repository/JIN 2.3/Page_Employees/input__last_name'), 'Testing' + new Random().nextInt(
        1000))

WebUI.setText(findTestObject('Object Repository/JIN 2.3/Page_Employees/input__email'), ('roof@tahute' + new Random().nextInt(
        1000)) + '.online')
...
a = WebUI.getNumberOfTotalOption(findTestObject('Object Repository/JIN 2.3/Page_Employees/a_Single                                        done'))
...
WebUI.selectOptionByIndex(findTestObject('JIN 2.3/Page_Employees/a_Single                                        done'), 
    count)
