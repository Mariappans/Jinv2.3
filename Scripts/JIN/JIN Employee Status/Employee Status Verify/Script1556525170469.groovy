...
WebUI.setText(findTestObject('Object Repository/JIN Employee Status/Page_Employees/input_search_search'), 'Digital Solutions Consultant')

WebUI.mouseOver(findTestObject('JIN Employee Status/Page_Employees/i_check_circle Verify'))

WebUI.delay(5)

WebUI.verifyTextPresent('Verified', true)
