...
WebUI.click(findTestObject('Object Repository/JIN Employee Status/Page_JIN Login/label_Email'))

WebUI.setText(findTestObject('Object Repository/JIN Employee Status/Page_JIN Login/input_JIN_email'), 'roof@sgbtukangsuntik.club')

WebUI.click(findTestObject('Object Repository/JIN Employee Status/Page_JIN Login/label_Password'))
...
WebUI.click(findTestObject('JIN Employee Status/Page_Dashboard/span_Emp2'))

WebUI.click(findTestObject('Object Repository/JIN Employee Status/Page_Dashboard/a_Logout'))
...
WebUI.setText(findTestObject('Object Repository/JIN Employee Status/Page_Employees/input_search_search'), 'qa engin')

WebUI.mouseOver(findTestObject('JIN Employee Status/Page_Employees/i_check_circle Activated'))

WebUI.delay(5)

WebUI.verifyTextPresent('Activated', true)
